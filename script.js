...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=d2d3b6c2e9ef1d5deb533a5436e67152')
.then(response => response.json())
.then(data => {

    //Obtenir les valeurs min et max pour chaque jour
    for(i = 0; i<5; i++){
        document.getElementById("day" + (i+1) + "Min").innerHTML = "Min: " + Number(data.list[i].main.temp_min - 273.15).toFixed(1)+ "°";
        //Nombre(1.3450001).toFixed(2); // 1.35
    }
...
function DefaultScreen(){
    document.getElementById("cityInput").defaultValue = "France";
    GetInfo();
}


//Obtenir et afficher le texte pour les cinq prochains jours de la semaine
var d = new Date();
var weekday = ["Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi", "Dimanche",];

//Fonction pour obtenir l'entier correct pour l'index du tableau des jours
